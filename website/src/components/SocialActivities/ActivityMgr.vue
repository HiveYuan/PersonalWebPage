<template>
	<div>
		<div v-for="Content in Contents">
			<simple-desc :Content="Content"></simple-desc>
		</div>
	</div>
</template>

<script>
import SimpleDesc from "@/components/common/SimpleDesc";
export default {
	name: "ActivityMgr",
	props: [],
	components: {
			...
			Contents: [
				{
					...
					intro:"Sky is a common background in photos, but because of the the time of photographing, " +
						...
						"into video process. Even if it can’t be played real time, the outcome still performs well.",
					result:"",
